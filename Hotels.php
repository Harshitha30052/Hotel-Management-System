...
<body>
  ...
  <div class="nav_bar">
    ...
    <div class="nav_menu">
      <ul>
        <li><a href="hotel.html" id="a">Home</a></li>
        <li><a href="hotel.html#footer" id="a">About Us</a></li>
        <li><a href="hotel.html#footer" id="a">Contact Us</a></li>
        <li><a href="random.html" id="a">Logout</a></li>
        <li><a href="Hotels.php" id="a">Packages</a></li>
        <li><a href="Food.html" id="a">Meals</a></li>
    ...
    <div class="profile_pic">
        <img src="profile.jpg" alt="Profile" id="profileToggle">
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  if (isAlreadySelected) {
    ...
    setTimeout(() => {
      window.location.href = "Rooms.html?hotel=" + encodeURIComponent(hotelName);
    }, 500);
  }
}
