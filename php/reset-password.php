...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($newPassword !== $confirmPassword) {
        echo "<script>alert('Passwords do not match. Please try again.'); window.location.href='../html/forget.html';</script>";
        exit();
    }
    ...
    if ($updated) {
        ...
        echo "<script>alert('Password has been reset successfully.'); window.location.href='../html/random.html';</script>";
    } else {
        echo "<script>alert('Email not found.'); window.location.href='../html/forget.html';</script>";
    }
